...
$container_id = docker run -d --name $env:container_name -l deployer=akkadotnet -p 1433:1433 -e sa_password=G!a7eZZM -e ACCEPT_EULA=Y microsoft/mssql-server-windows-express
